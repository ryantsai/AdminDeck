...
fn ai_tool_definitions(settings: &AiAssistantToolSettings) -> Vec<OpenAiToolDefinition> {
    ...
    if settings.dashboard() {
        ...
        tools.push(tool_definition(
            ...
            "Add a widget instance to a Dashboard view at a specific grid position. When placing an existing AI Created Widget (kind content or script), default preset to \"ambient\" unless the user explicitly asks for a titled chrome (\"panel\") or a hero treatment.",

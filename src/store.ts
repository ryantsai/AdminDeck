...
// Stable ASCII slugs for remote tmux session names. Keep these code-facing,
// trademark-neutral, and localized only as display labels so existing remote
// tmux sessions are never renamed by a language switch.
...
function randomTmuxName() {
  ...
  return TMUX_SESSION_NAMES[index] ?? "neonunit";
}
